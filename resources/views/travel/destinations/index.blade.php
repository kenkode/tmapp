           ...
           {{ csrf_field() }}
            <div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        <form target="_blank" action="{{url('report/destinations')}}" method="post">     
                                        <div class="modal-body">
        ...
        <tr class="{{'del'.$destination->id}}">
          ...
          <td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a class="view" data-toggle="modal" data-name="{{$destination->name}}"  data-id="{{$destination->id}}" href="#modal-view">View</a></li>

                    <li><a class="edit" data-toggle="modal" data-name="{{$destination->name}}"  data-id="{{$destination->id}}" href="#modal-form">Update</a></li>
  ...
  $(document).ready(function() {    
    ...
    $('#submit').removeAttr('disabled');
     ...
     function displaydata(){
       $.ajax({
                      url     : "{{URL::to('destinations/showrecord')}}",
                      type    : "GET",
                      async   : false,
