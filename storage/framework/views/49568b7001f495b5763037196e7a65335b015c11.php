        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    <h5>
                        <?php echo e(strtoupper($organization->name).' '.strtoupper("Advance Payment Settings")); ?>
                    ...
                    <div class="panel blank-panel">
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        <form target="_blank" action="<?php echo e(url('report/deposits')); ?>" method="post">     
                                        <div class="modal-body">
                                    ...
                                    <table style="margin-left: 15px;border-spacing:0 1em; border-collapse: separate;">
                                        ...
                                        <?php if(count($deposit)>0): ?>
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="jan" placeholder="Enter %" class="form-control" maxlength="6" value="<?php echo e($deposit->jan * 100); ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="feb" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->feb * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#feb').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="mar" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->mar * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#mar').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="apr" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->apr * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#apr').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                <td width="100">May</td>
                                                <td>
                                                 <input type="text" id="may" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->may * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#may').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="jun" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->jun * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#jun').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="jul" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->jul * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#jul').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="aug" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->aug * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#aug').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="sep" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->sep * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#sep').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="oct" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->oct * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#oct').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="nov" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->nov * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#nov').priceFormat();
                                                 });
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <input type="text" id="dec" placeholder="Enter %" maxlength="6" class="form-control" value="<?php echo e($deposit->dec * 100); ?>">
                                                 <script type="text/javascript">
                                                 $(document).ready(function() {
                                                 $('#dec').priceFormat();
                                                 });
