                    ...
                    <div class="panel blank-panel">
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        <form target="_blank" action="<?php echo e(url('report/roomtypes')); ?>" method="post">     
                                        <div class="modal-body">
                                            ...
                                            <tbody class="displayrecord">
                                              <?php $i=1;?>
                                               <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?> 
                                                <tr class="<?php echo e('del'.$type->id); ?>">
                                                  <td><?php echo e($i); ?></td>                 
                                                  ...
                                                  <td>
                                                      <div class="btn-group">
                                                          ...
                                                          <li>
                                                                <a class="view" data-toggle="modal" data-name="<?php echo e($type->name); ?>" data-id="<?php echo e($type->id); ?>" href="#modal-view">
                                                                    View
                                                                </a>
                                                            </li>    
                                                            <li>
                                                                <a class="edit" data-toggle="modal" data-name="<?php echo e($type->name); ?>" data-id="<?php echo e($type->id); ?>" href="#modal-form">
                                                                    Update
                                                                </a>
                                                            </li>                   
                                                            <li>
                                                                <a id="<?php echo e($type->id); ?>" class="delete">
                                                                    <form id="delform">
                                                                    <?php echo e(csrf_field()); ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {    
    ...
    function displaydata(){
       $.ajax({
          url     : "<?php echo e(URL::to('roomtype/showrecord')); ?>",
          type    : "GET",
          async   : false,       
          success : function(s){
