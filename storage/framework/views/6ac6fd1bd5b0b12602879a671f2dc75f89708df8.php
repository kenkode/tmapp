...
<head>
    ...
    <!-- Data Tables -->
    <link href="<?php echo e(URL::to('/assets/css/plugins/dataTables/dataTables.bootstrap.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(URL::to('/assets/css/plugins/dataTables/dataTables.responsive.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(URL::to('/assets/css/plugins/dataTables/dataTables.tableTools.min.css')); ?>" rel="stylesheet">
    <!-- Gritter -->
...
<body>
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" method="post" action="<?php echo e(url('/search_results')); ?>">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    ...
                    Welcome <?php echo e(Auth::user()->name); ?></span>
                </li>                                                
                <li>
                    <a href="<?php echo e(url('/logout')); ?>"
                        onclick="event.preventDefault();
