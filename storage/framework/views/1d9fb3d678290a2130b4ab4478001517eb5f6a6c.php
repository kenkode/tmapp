...
<div class="pro-head">
                                    ...
                                    <div class="modal-content animated fadeIn">
                                        ...
                                        <h3 id="title" class="m-t-none m-b">Create Payment Option</h3>
                                            ...
                                            <select id="did" class="form-control">
                                             ...
                                             <div class="form-group"><label>Children% (Enter a percentage of adult fare)<span style="color:red">*</span></label> 
      ...
      <thead style="background:#263949">
        ...
        <th style="color:#FFF">First Class Fare (<?php echo e($currency); ?>)</th>
        <th style="color:#FFF">Business Class Fare (<?php echo e($currency); ?>)</th>
      ...
      <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
        <tr class="<?php echo e('del'.$payment->id); ?>">
          ...
          <td><?php echo e(number_format($payment->business,2)); ?></td>
          <td><?php echo e(number_format($payment->economic,2)); ?></td>
          <td><?php echo e($payment->children); ?></td>
          <td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a class="view" data-toggle="modal" data-vip="<?php echo e(number_format($payment->firstclass,2)); ?>" data-economic="<?php echo e(number_format($payment->economic,2)); ?>" data-business="<?php echo e(number_format($payment->business,2)); ?>" data-children="<?php echo e($payment->children); ?>" data-id="<?php echo e($payment->id); ?>" data-name="<?php echo e(App\Payment::getVehicle($payment->vehicle_id)); ?>" data-origin="<?php echo e(App\Schedule::getDestination($payment->origin_id)->name); ?>" data-destination="<?php echo e(App\Schedule::getDestination($payment->destination_id)->name); ?>" href="#modal-view">View</a></li>

                    <li><a class="edit" data-toggle="modal" data-vip="<?php echo e(number_format($payment->firstclass,2)); ?>" data-economic="<?php echo e(number_format($payment->economic,2)); ?>" data-children="<?php echo e($payment->children); ?>" data-origin="<?php echo e($payment ->origin_id); ?>" data-business="<?php echo e(number_format($payment->business,2)); ?>" data-destination="<?php echo e($payment->destination_id); ?>" data-id="<?php echo e($payment->id); ?>" data-name="<?php echo e($payment->vehicle_id); ?>"  href="#modal-form">Update</a></li>
  ...
  $(document).ready(function() {    
   ...
   $('#add').on("click", function() {
    ...
    $("#users").on("click",".view", function(){
     ...
     $(".modal-body .tdfirstchild").html( '<?php echo e($currency); ?> '+ ( result ));
     $(".modal-body .tdbusiness").html( '<?php echo e($currency); ?> '+business );
     $(".modal-body .tdbusinesschild").html( '<?php echo e($currency); ?> '+ ( numeral(parseFloat(business.replace(/,/g, '')) * children/100)).format('0,0.00') );
     $(".modal-body .tdeconomic").html( '<?php echo e($currency); ?> '+economic );
     $(".modal-body .tdeconomicchild").html( '<?php echo e($currency); ?> '+ ( numeral(parseFloat(economic.replace(/,/g, '')) * children/100)).format('0,0.00'));
   });
