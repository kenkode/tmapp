...
<div class="pro-head">
           ...
           <?php echo e(csrf_field()); ?>
            ...
            <div class="modal fade" id="modal-form" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        <form target="_blank" action="<?php echo e(url('report/currencies')); ?>" method="post">     
                                        <div class="modal-body">
      ...
      <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
        <tr class="<?php echo e('del'.$currency->id); ?>">
          <td><?php echo e($i); ?></td>
          <td><?php echo e($currency->shortname); ?></td>
          ...
          <td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a class="view" data-toggle="modal" data-name="<?php echo e($currency->name); ?>" data-shortname="<?php echo e($currency->shortname); ?>" data-id="<?php echo e($currency->id); ?>" href="#modal-view">View</a></li>

                    <li><a class="edit" data-toggle="modal" data-name="<?php echo e($currency->name); ?>" data-shortname="<?php echo e($currency->shortname); ?>" data-id="<?php echo e($currency->id); ?>" href="#modal-form">Update</a></li>
                   
                    <li><a id="<?php echo e($currency->id); ?>" class="delete">
                    <form id="delform">
                    <?php echo e(csrf_field()); ?>
  ...
  $(document).ready(function() {    
    ...
    $('#submit').removeAttr('disabled');
     ...
     function displaydata(){
       $.ajax({
                      url     : "<?php echo e(URL::to('currencies/showrecord')); ?>",
                      type    : "GET",
                      async   : false,
...
<script type="text/javascript">
   ...
   $("#users").on("click",".delete", function(){
                ...
                if(confirm("Are you sure you want to delete this currency?")){
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(url('currencies/delete')); ?>",
