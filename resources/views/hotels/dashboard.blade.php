                    ...
                    <div class="col-sm-3">
                        ...
                        <ul class="list-group clear-list m-t">
                            ...
                            <li class="list-group-item">
                                ...
                                <span class="label label-success">4</span> Rooms
                            </li>
                            <li class="list-group-item">
                                <span class="pull-right">
                                    {{$foods}}
                                </span>
                                <span class="label label-success">5</span> Foods
                            </li>
                            <li class="list-group-item">
                                <span class="pull-right">
                                    {{$schedules}}
                                </span>
                                <span class="label label-warning">6</span> Schedules
                            </li>
                            <li class="list-group-item">
                                <span class="pull-right">
                                    {{$branches}}
                                </span>
                                <span class="label label-primary">7</span> Branches
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-9">
