          ...
          <td>{{$schedule->departure}}</td>
           --><td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a class="view" data-toggle="modal" data-name="{{App\Schedule::getVehicle($schedule->vehicle_id)->regno.' '.App\Schedule::getVehicle($schedule->vehicle_id)->vehiclename->name}}" data-origin="{{App\Schedule::getDestination($schedule->origin_id)->name}}" data-id="{{$schedule->id}}" data-destination="{{App\Schedule::getDestination($schedule->destination_id)->name}}" data-arrival="{{$schedule->arrival}}" data-departure="{{$schedule->departure}}" data-vip="{{$schedule->firstclass_apply}}" data-business="{{$schedule->business_apply}}" data-children="{{$schedule->children_apply}}" data-economic="{{$schedule->economic_apply}}" href="#modal-view">View</a></li>

                    <li><a class="edit" data-toggle="modal" data-name="{{$schedule->vehicle_id}}" data-origin="{{$schedule ->origin_id}}" data-id="{{$schedule->id}}" data-destination="{{$schedule->destination_id}}" data-arrival="{{$schedule->arrival}}" data-departure="{{$schedule->departure}}" data-vip="{{$schedule->firstclass_apply}}" data-business="{{$schedule->business_apply}}" data-children="{{$schedule->children_apply}}" data-economic="{{$schedule->economic_apply}}" href="#modal-form">Update</a></li>
