                    ...
                    <div class="panel blank-panel">
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content animated fadeIn">
                                        <form target="_blank" action="{{url('report/branches')}}" method="post">     
                                        <div class="modal-body">
                                                ...
                                                <tr class="{{'del'.$branch->id}}">
                                                  ...
                                                  <td>
                                                      <div class="btn-group">
                                                          ...
                                                          <li>
                                                                <a class="view" data-toggle="modal" data-name="{{$branch->name}}" data-id="{{$branch->id}}" href="#modal-view">
                                                                    View
                                                                </a>
                                                            </li>    
                                                            <li>
                                                                <a class="edit" data-toggle="modal" data-name="{{$branch->name}}" data-id="{{$branch->id}}" href="#modal-form">
                                                                    Update
                                                                </a>
                                                            </li>                   
                                                            <li>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {    
    ...
    function displaydata(){
       $.ajax({
          url     : "{{URL::to('hotelbranches/showrecord')}}",
          type    : "GET",
          async   : false,       
          success : function(s){
