...
<style type="text/css">
    ...
    background-image:url("{{url('/public/uploads/logo/'.$organization->logo)}}");
...
<script type="text/javascript">
  ...
  $(document).ready(function() {    
     ...
     function displaydata(){
       $.ajax({
                      url     : "{{URL::to('organizations/showrecord')}}",
                      type    : "GET",
                      async   : false,
